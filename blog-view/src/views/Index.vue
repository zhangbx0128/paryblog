...
<!--    分享pray-z的歌单《pray-z的2021年度歌单》https://y.music.163.com/m/playlist?app_version=8.7.65&id=7183045019&userid=340558360&dlt=0846&creatorId=340558360 (@网易云音乐)-->
    <!-- 音乐播放器 -->
    <div>
      <meting-js server="netease" type="playlist" id="7183045019" fixed="true" mini="true" ></meting-js>
    </div>
...
<!--    <div id = "test1"></div>-->
<!--    <script src="http:/127.0.0.1/453535/static/layui/layui.js"></script>-->
<!--    <script>-->
...
export default {
  name: "Index",
  components: {HotMessage, RightCard, Footer, Navbar, Card, Calendar,HeadPhoto},
  data() {
    return {
      focusMode: false,
    }
...
.index-container {
  min-height: 100vh;
  background-image: url("https://cdn.jsdelivr.net/gh/zhangbx0128/picture@main/down.jpg")!important; ;
