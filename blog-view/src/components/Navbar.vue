  ...
  <div class="blog-navbar" :class="{'transparent':$route.name==='Home' }">
    ...
    <router-link style="text-decoration-line: none;color: white" to="/">
      <h3 :class="{'m-mobile-show': mobileHide,'active':$route.name==='About'}"
          class="ui header item m-blue" style="display: inline;padding:20px 20px 20px 60px">Pray's
        Blog</h3>
    </router-link>
    ...
    <router-link :class="{'m-mobile-show': mobileHide,'active':$route.name==='Dongtai'}" class="item" style="text-decoration-line: none;color: white;padding:20px"
                 to="/dongtai">
      动态
    </router-link>

    <router-link :class="{'m-mobile-show': mobileHide,'active':$route.name==='MessageBoard'}" class="item" style="text-decoration-line: none;color: white;padding:20px"
                 to="/messageboard">
      留言板
    </router-link>
    ...
    <el-dropdown v-if="user" class="user" trigger="click" @command="logout" style="margin-left: 449px; ">
      <div class="el-dropdown-link">
        <el-avatar :size="35" :src="user.avatar" fit="contain" shape="square"></el-avatar>
      </div>
      <el-dropdown-menu slot="dropdown">
        <el-dropdown-item icon="ali-iconfont icon-logout">个人信息</el-dropdown-item>
        <el-dropdown-item icon="ali-iconfont icon-logout">修改密码</el-dropdown-item>
        <el-dropdown-item icon="ali-iconfont icon-logout">忘记密码</el-dropdown-item>
        <el-dropdown-item icon="ali-iconfont icon-logout">个人后台</el-dropdown-item>
