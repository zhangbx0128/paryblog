...
import com.baixin.config.RabbitConfig;
import com.baixin.entity.*;
import com.baixin.search.mq.PostMqIndexMessage;
import com.baixin.util.ValidationUtil;
...
public class PostController extends BaseController{
    ...
    public Result collectionAdd(Long pid) {
        ...
        return Result.succ(collectionService);
    }
    ...
    public Result submit(Post post) {
        ...
        return Result.succ(amqpTemplate).action("/post/" + post.getId());
    }
    ...
    public Result delete(Long id) {
        ...
        return Result.succ(amqpTemplate).action("/user/index");
    }
    ...
    public Result reply(Long jid, String content) {
        ...
        return Result.succ(messageService).action("/post/" + post.getId());
    }
